...
```text
Федеральный закон от 27 июля 2006 г. N 149-ФЗ "Об информации, информационных технологиях и о защите информации" (с изменениями и дополнениями) Статья 2. Основные понятия, используемые в настоящем Федеральном законе
...
Различие: Предоставление - ограниченному кругу лиц, распространение - неограниченномуё 
```
...
```text
была нарушена конфиденциальность, потому что персональные данные попали к злоумышленнику, которые он использовал неправомерно, и получил возможность распространения данной информации неопределенному кругу лиц
