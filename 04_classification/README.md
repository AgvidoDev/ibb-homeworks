...
- Категория персональных данных: относятся к специальным категориям (паспортные данные).
- Объем обрабатываемых персональных данных: менее 100 тысяч записей.
- Условия обработки персональных данных: автоматизированный режим.
- Цели обработки персональных данных: связаны с осуществлением деятельности субъекта персональных данных.
- Способы обработки персональных данных: без передачи по открытым каналам связи.
- Наличие трансграничной передачи персональных данных: отсутствует.
- Угрозы безопасности персональных данных: средний уровень.
- Последствия нарушения безопасности персональных данных: высокие последствия.

На основании указанных критериев уровень защищенности ИСПДн "Зарплата и кадры" определяется как уровень защищенности 3.

ИСПДн - Счастливый клиент

- Категория персональных данных: не относятся к специальным категориям.
- Объем обрабатываемых персональных данных: более 100 тысяч записей.
- Условия обработки персональных данных: автоматизированный режим.
- Цели обработки персональных данных: не связаны с осуществлением деятельности субъекта персональных данных.
- Способы обработки персональных данных: без передачи по открытым каналам связи.
- Наличие трансграничной передачи персональных данных: отсутствует.
- Угрозы безопасности персональных данных: средний уровень.
- Последствия нарушения безопасности персональных данных: средние последствия.

Определение уровня защищенности
На основании указанных критериев уровень защищенности ИСПДн "Счастливый клиент" определяется как уровень защищенности 2 (средний).
