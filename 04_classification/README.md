...
- Категория персональных данных - иные ИСПДн
- Количество субъектов персональных данных - 50 сотрудников;
- Объём персональных данных - небольшой (данные о заработной плате, кадровые данные);
...
На основании задания, в рамках которого угрозы 1 и 2 уровня не актуальны для данного ПО, по указанным критериям уровень 
защищенности ИСПДн "Зарплата и кадры" определяется как уровень защищенности 4. 
