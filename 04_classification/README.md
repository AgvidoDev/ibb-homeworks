...
ИСПДн Обработка персональных данных сотрудников
ИСПДн - Счастливый клиент
Схема Определение уровня защищенности
Название ИСПДн - Зарплата и кадры:
Критерий 1 (тип данных) - персональные данные сотрудников;
Критерий 2 (количество лиц) - 50;
Критерий 3 (доступ к интернету) - да;
Название ИСПДн - Обработка персональных данных сотрудников:
Критерий 4 (передача данных за границу) - нет;
Название ИСПДн - Счастливый клиент: 
Критерий 1 (тип данных)  персональные данные клиентов; 
Критерий 2 (количество лиц)  200 тыс. человек; 
Критерий 3 (наличие доступа к интернету)  нет; 
Критерий 4 (наличие антивируса)  да; 
Критерий 5 (резервное копирование данных)  да.
```
