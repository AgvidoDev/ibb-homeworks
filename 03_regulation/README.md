...
Здание может считаться объектом защиты в случае, если в нем обрабатывается информация, составляющая государственную тайну, либо информация для служебного пользования в органах государственной власти, на предприятиях, в учреждениях и организациях, независимо от формы собственности.
